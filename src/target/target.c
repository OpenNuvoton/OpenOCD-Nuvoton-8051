...
extern struct target_type numicro8051_target;
...
{
//	LOG_DEBUG("target_register_event_callback");
	struct target_event_callback **callbacks_p = &target_event_callbacks;
//	LOG_DEBUG("target_register_event_callback2");

	if (callback == NULL) {
//		LOG_DEBUG("target_register_event_callback3");
		return ERROR_COMMAND_SYNTAX_ERROR;
	}
//	LOG_DEBUG("target_register_event_callback4");
	if (*callbacks_p) {
//		LOG_DEBUG("target_register_event_callback5");
		while ((*callbacks_p)->next)
			callbacks_p = &((*callbacks_p)->next);
		callbacks_p = &((*callbacks_p)->next);
	}
//	LOG_DEBUG("target_register_event_callback6");
	(*callbacks_p) = malloc(sizeof(struct target_event_callback));
//	LOG_DEBUG("target_register_event_callback7");
	(*callbacks_p)->callback = callback;
//	LOG_DEBUG("target_register_event_callback8");
	(*callbacks_p)->priv = priv;
//	LOG_DEBUG("target_register_event_callback9");
	(*callbacks_p)->next = NULL;
//	LOG_DEBUG("target_register_event_callback10");
