...
extern int nulink_set_flash_mode(void);
extern int nulink_mcu_disconnect(void);
extern int nulink_flash_init(void);
extern int nulink_flash_sprom_init(void);
extern int nulink_flash_uninit(void);
