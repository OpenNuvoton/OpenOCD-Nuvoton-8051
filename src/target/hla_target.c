...
struct target_type hla_target = {
	...
	.init_target = numicro8051_init_target,//adapter_init_target,
	.deinit_target = numicro8051_deinit_target,//cortex_m_deinit_target,
	.target_create = numicro8051_target_create,//adapter_target_create,
	.examine = numicro8051_examine,
	.commands = adapter_command_handlers,

	.poll = numicro8051_poll,//adapter_poll,
	.arch_state = numicro8051_arch_state,

	.target_request_data = hl_target_request_data,
	.assert_reset = numicro8051_assert_reset,//adapter_assert_reset,
	.deassert_reset = numicro8051_deassert_reset,//adapter_deassert_reset,

	.halt = numicro8051_halt,//adapter_halt,
	.resume = numicro8051_resume,//adapter_resume,
	.step = numicro8051_step,

	.get_gdb_reg_list = numicro8051_get_gdb_reg_list,//armv7m_get_gdb_reg_list,

	.read_memory = numicro8051_read_memory,//adapter_read_memory,
	.write_memory = numicro8051_write_memory,//adapter_write_memory,
	...
	.add_breakpoint = numicro8051_add_breakpoint, //cortex_m_add_breakpoint,
	.remove_breakpoint = numicro8051_remove_breakpoint, //cortex_m_remove_breakpoint,
