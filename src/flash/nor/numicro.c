...
static const struct numicro_cpu_type NuMicroParts[] = {
	...
	{"MG51LD1AE", 0x00007244},
	{"MG51TD1AE", 0x0C007244},
	{"MG51PD1AE", 0x01007244},
	{"MG51LC1AE", 0x00007234},
	{"MG51TC1AE", 0x0C007234},
	{"MG51PC1AE", 0x01007234},
	{"MG51EC1AE", 0x02007234},

	{"CM1003BF3AE", 0x25006721},
	{"CM1003BF2AE", 0x2B006721},
	{"CM1003CF3AE", 0x25006731},
	{"CM1003CF2AE", 0x2B006731},

	{"CM1003DL8AE", 0x20007244},
	{"CM1003DJ3AE", 0x2C007244},
	{"CM1003DJ8AE", 0x21007244},
	{"CM1003CJ3AE", 0x2C007234},
	{"CM1003CH2AE", 0x22007234},
...
FLASH_INFO_BY_DID_T g_FlashDIDs[] = {
	// N76E003
	{ 18*1024, 0, 0x0300, 0x00003650, ((1 << 31) | (0 << 25) | (0 << 24) | (0x0E << 8) | (0 << 7) | (0 << 6) | (0 << 5) | (0 << 4) | (0 << 2) | (0 << 0))},
	{ 18*1024, 0, 0x0300, 0x00003640, ((1 << 31) | (0 << 25) | (0 << 24) | (0x0E << 8) | (0 << 7) | (0 << 6) | (0 << 5) | (0 << 4) | (0 << 2) | (1 << 0))},

	// ML51
	{  8*1024, 0, 0x0400, 0x00004711, ((1 << 31) | (0 << 25) | (1 << 24) | (0x0F << 8) | (0 << 7) | (1 << 6) | (1 << 5) | (1 << 4) | (0 << 2) | (0 << 0))},
	{ 16*1024, 0, 0x0400, 0x00004721, ((1 << 31) | (0 << 25) | (1 << 24) | (0x0F << 8) | (0 << 7) | (1 << 6) | (1 << 5) | (1 << 4) | (0 << 2) | (0 << 0))},

	{ 16*1024, 0, 0x0400, 0x00004821, ((1 << 31) | (0 << 25) | (1 << 24) | (0x0F << 8) | (0 << 7) | (1 << 6) | (1 << 5) | (1 << 4) | (0 << 2) | (0 << 0))},
	{ 32*1024, 0, 0x0800, 0x00004832, ((1 << 31) | (0 << 25) | (1 << 24) | (0x0F << 8) | (0 << 7) | (1 << 6) | (1 << 5) | (1 << 4) | (0 << 2) | (0 << 0))},

	{ 32*1024, 0, 0x0800, 0x00004932, ((1 << 31) | (0 << 25) | (1 << 24) | (0x0F << 8) | (0 << 7) | (1 << 6) | (1 << 5) | (1 << 4) | (0 << 2) | (0 << 0))},
	{ 64*1024, 0, 0x1000, 0x00004944, ((1 << 31) | (0 << 25) | (1 << 24) | (0x0F << 8) | (0 << 7) | (1 << 6) | (1 << 5) | (1 << 4) | (0 << 2) | (0 << 0))},

	// MS51
	{  8*1024, 0, 0x0200, 0x00004B10, ((1 << 31) | (0 << 25) | (1 << 24) | (0x0E << 8) | (0 << 7) | (1 << 6) | (1 << 5) | (1 << 4) | (0 << 2) | (0 << 0))},
	{  8*1024, 0, 0x0400, 0x00004B11, ((1 << 31) | (0 << 25) | (1 << 24) | (0x0E << 8) | (0 << 7) | (1 << 6) | (1 << 5) | (1 << 4) | (0 << 2) | (0 << 0))},
	{ 16*1024, 0, 0x0200, 0x00004B20, ((1 << 31) | (0 << 25) | (1 << 24) | (0x0E << 8) | (0 << 7) | (1 << 6) | (1 << 5) | (1 << 4) | (0 << 2) | (0 << 0))},
	{ 16*1024, 0, 0x0400, 0x00004B21, ((1 << 31) | (0 << 25) | (1 << 24) | (0x0E << 8) | (0 << 7) | (1 << 6) | (1 << 5) | (1 << 4) | (0 << 2) | (0 << 0))},

	{  8*1024, 0, 0x0400, 0x00005211, ((1 << 31) | (0 << 25) | (1 << 24) | (0x0E << 8) | (0 << 7) | (1 << 6) | (1 << 5) | (1 << 4) | (0 << 2) | (0 << 0))},

	{ 16*1024, 0, 0x0800, 0x00005322, ((1 << 31) | (0 << 25) | (1 << 24) | (0x0E << 8) | (0 << 7) | (1 << 6) | (1 << 5) | (1 << 4) | (0 << 2) | (0 << 0))},
	{ 32*1024, 0, 0x0800, 0x00005332, ((1 << 31) | (0 << 25) | (1 << 24) | (0x0E << 8) | (0 << 7) | (1 << 6) | (1 << 5) | (1 << 4) | (0 << 2) | (0 << 0))},

	// ML56
	{ 32*1024, 0, 0x1000, 0x00005734, ((1 << 31) | (1 << 25) | (1 << 24) | (0x07 << 8) | (1 << 7) | (1 << 6) | (1 << 5) | (1 << 4) | (0 << 2) | (0 << 0))},
	{ 64*1024, 0, 0x1000, 0x00005744, ((1 << 31) | (1 << 25) | (1 << 24) | (0x07 << 8) | (1 << 7) | (1 << 6) | (1 << 5) | (1 << 4) | (0 << 2) | (0 << 0))},

	// MUG51
	{ 16*1024, 0, 0x0400, 0x00006321, ((1 << 31) | (1 << 25) | (1 << 24) | (0x0F << 8) | (0 << 7) | (1 << 6) | (1 << 5) | (1 << 4) | (0 << 2) | (0 << 0))},

	// MG51, N76S003
	{ 18*1024, 0, 0x0400, 0x00006750, ((1 << 31) | (0 << 25) | (0 << 24) | (0x0E << 8) | (0 << 7) | (1 << 6) | (1 << 5) | (1 << 4) | (0 << 2) | (0 << 0))},
	{ 16*1024, 0, 0x0400, 0x00006721, ((1 << 31) | (0 << 25) | (1 << 24) | (0x0E << 8) | (0 << 7) | (1 << 6) | (1 << 5) | (1 << 4) | (0 << 2) | (0 << 0))},
	{ 32*1024, 0, 0x0400, 0x00006731, ((1 << 31) | (0 << 25) | (1 << 24) | (0x0E << 8) | (0 << 7) | (1 << 6) | (1 << 5) | (1 << 4) | (0 << 2) | (0 << 0))},

	// MG51 64K
	{ 64*1024, 0, 0x1000, 0x00007244, ((1 << 31) | (0 << 25) | (1 << 24) | (0x0E << 8) | (0 << 7) | (1 << 6) | (1 << 5) | (1 << 4) | (0 << 2) | (0 << 0))},
	{ 32*1024, 0, 0x1000, 0x00007234, ((1 << 31) | (0 << 25) | (1 << 24) | (0x0E << 8) | (0 << 7) | (1 << 6) | (1 << 5) | (1 << 4) | (0 << 2) | (0 << 0))},
};
							...
							FLASH_INFO_BY_DID_T *pInfo2)
{
	...
	switch (uSID)
	{
		...
		case OT8051_SID_MG51_64K:
		{
			...
			pInfo->uSPROM_Mode		= 0;
			pInfo->uSCODE_Addr		= ML51_SCODE_ADDR;
			pInfo->uSFR_PageNum		= (uSID == OT8051_SID_MG51_64K) ? 3 : 0;
			...
			if (((uPID >> 12) & 0x0F) == 0x02)
			{
				pInfo->pszSeriesName	= "CM1003";
			}
